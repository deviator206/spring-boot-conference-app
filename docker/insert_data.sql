...
_WebResourceData_WebResourceMIMEType_WebResourceTextEncodingName^WebResourceURL_WebResourceFrameNameO:e<html><head></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;">INSERT INTO ticket_types (ticket_type_code,ticket_type_name,description,includes_workshop)
...
</pre></body></html>Ztext/plainUUTF-8_nhttps://raw.githubusercontent.com/dlbunker/ps-first-spring-boot-app/master/database/postgresql/insert_data.sqlP    ( : P n } ”:ý;;;                           ;€